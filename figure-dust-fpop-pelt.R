...
gg <- ggplot()+
  ...
  scale_y_log10(
    ...
    breaks=10^seq(-3,0),
    limits=10^c(-3,1))
png("figure-dust-fpop-pelt-seconds.png", units="in", width=13.5, height=5.2, res=200)
print(gg)
dev.off()
...
gg <- ggplot()+
  ...
  scale_y_log10(
    ...
    limits=10^c(0, 4))
png("figure-dust-fpop-pelt-candidates.png", units="in", width=13.5, height=5.5, res=200)
print(gg)
dev.off()
